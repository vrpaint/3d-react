        ...
        return (
            <Scene>
                ...
                <Entity
                    ...
                    material={{color: this.props.data.color}}
                    ...
                    events={{
                        ...
                        collided: [(event) => {
                            console.log('Collided!',event);
                        }]}}


                />
                <Entity geometry={{primitive: 'sphere'}} material={{color: this.props.data.color}} position={{x: 0, y: 0, z: -5}}/>
                <Entity primitive='a-sky' material={{color: '#85e9ec'}}/>
